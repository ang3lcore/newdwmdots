...
static const char col_cyan[]        = "#40a7e3";
static const char col_white[]       = "#ffffff";
static const char col_black[]       = "#000000";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_white, col_black, col_gray2 },
	[SchemeSel]  = { col_white, col_black,  col_gray2  },
...
static const Rule rules[] = {
	...
	{ "Gimp",     NULL,       NULL,       0,            1,           -1 },
        { "Legacy Launcher", NULL, NULL,      0,            1,           -1 },
};
...
#define TAGKEYS(KEY,TAG) \
	{ CTLKEY,                       KEY,      view,           {.ui = 1 << TAG} }, \
	{ MODKEY|ControlMask,           KEY,      toggleview,     {.ui = 1 << TAG} }, \
	{ CTLKEY|ShiftMask,             KEY,      tag,            {.ui = 1 << TAG} }, \
	{ MODKEY|ControlMask|ShiftMask, KEY,      toggletag,      {.ui = 1 << TAG} }, \
        { ALTKEY,                       KEY,      focusnthmon,    {.i  = TAG } }, \
        { ALTKEY|ShiftMask,             KEY,      tagmon,      {.i  = TAG } },
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_white, "-sb", col_white, "-sf", col_black, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *flameshot[] = { "flameshot", "gui", NULL };
static const char *brightdown[] = { "lightminus", NULL};
static const char *brightup[] = { "lightplus", NULL};
